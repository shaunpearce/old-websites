...
function fillbill(){
   ...
   {
	   document.getElementById("hardwarecont").innerHTML = 600;
   ...
   else  if (document.getElementById('radio-2-3').checked)
   {
	  ...
	  /* document.getElementById("hardwaretotal").innerHTML = 600;*/
   }
   else  if (document.getElementById('radio-2-2').checked)
   {
	   ...
	   /*document.getElementById("hardwaretotal").innerHTML = 300;*/
   }
   /*displaycont();*/
	displaytotals()
 }
 ...
 function fillbill2(){
	 ...
	 document.getElementById("hardwaretotal").innerHTML = 600 - entry;
...
function displaycont(){
		...
		var totcont = 0;
		var hc = document.getElementById("hardwarecont").innerHTML;
		...
		var tc = document.getElementById("splitequation").innerHTML;
		
			var b = parseInt(tc);
			totcont += b;
	
		var balance = 1000 - totcont ;
		document.getElementById("employeebal").innerHTML = balance;

		var employerbal = 1000 - balance;
		...
		document.getElementById("employercont").innerHTML = employerbal;

		var total = balance + employerbal;
