 ...
 <div id="uploaderrors" class="uploaderrors"> 
  <?php
   ...
   ?>
 	...
 	<form action="upload2_action.php" method="post" enctype="multipart/form-data" >
    
   <h3 id="uploadtitle">Sale Information:</h3>
  ...
  <input type="number" name="book_price" size="30" value="<?php if (isset($_POST['book_price'])) echo $_POST['book_price']; ?>" placeholder="*Required"> <br><br />
    ...
    <div id="contact" class="checkboxes">  
      ...
      Email <input  type="checkbox" id="checkbox-2-1" class="checkbox big-checkbox" name="contact_email" <?php if(isset($_POST['contact_email']))echo'checked'; ?>/>
      <label id="check" for="checkbox-2-1"></label>
      Phone <input type="checkbox" id="checkbox-2-2" class="checkbox big-checkbox"  name="contact_phone" <?php if(isset($_POST['contact_phone']))echo'checked'; ?>/>
      <label id="check" for="checkbox-2-2"></label>
    ...
    <label for="County">County & College</label>
      ...
      </select><label for="College"></label>
